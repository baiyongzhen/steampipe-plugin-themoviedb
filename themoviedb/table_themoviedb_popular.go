...
* tmdb api function: GetMoviePopular
*/
func tablePopular() *plugin.Table {
	return &plugin.Table{
		Name: "themoviedb_popular",
...
func listPopular(ctx context.Context, 
	...
	for {
		movies, err := conn.GetMoviePopular(options)
		if err != nil {
			logger.Trace("GetMoviePopular Error:", err.Error())
			return nil, err
		}
...
func getPopular(ctx context.Context, 
	d *plugin.QueryData, 
